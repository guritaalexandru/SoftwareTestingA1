...
def test_load_products_from_csv_optimal(csv_file_optimal_state, csv_name, csv_units, csv_price):
...
def test_load_products_from_csv_edge(csv_file_optimal_state, csv_name, csv_units, csv_price):
...
def test_load_products_from_csv_added_head_file(csv_file_added_head_state, csv_name, csv_units, csv_price):
...
def test_load_products_from_csv_added_column_file_2(csv_file_added_column_state_2, csv_name, csv_units, csv_price):
...
def test_load_products_from_csv_added_column_file_3(csv_file_added_column_state_3, csv_name, csv_units, csv_price):
